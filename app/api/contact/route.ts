    ...
    const { data, error } = await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #0f172a; color: #f8fafc; padding: 32px; border-radius: 12px;">
          <div style="border-bottom: 3px solid #457bb3; padding-bottom: 16px; margin-bottom: 24px;">
            <h1 style="margin: 0; font-size: 22px; color: #457bb3;">Nuevo mensaje de contacto</h1>
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 10px 0;">
                <a href="mailto:${email}" style="color: #457bb3;">${email}</a>
              </td>
            </tr>
            <tr>
          ...
          <div style="margin-top: 32px; padding: 16px; background: #1e293b; border-radius: 8px; border-left: 3px solid #457bb3;">
